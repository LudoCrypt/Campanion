...
public class CampanionData implements DossierProvider {
	...
	private static class CampanionRecipesGenerator extends RecipesDossier {
		...
		protected void addRecipes(Consumer<RecipeJsonProvider> exporter) {
			ShapedRecipeJsonFactory.create(CampanionItems.MARSHMALLOW, 2).input('S', Items.SUGAR).pattern("SS").pattern("SS").criterion("has_sugar", this.conditionsFrom(Items.SUGAR)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionItems.MARSHMALLOW_ON_A_STICK).input(CampanionItems.MARSHMALLOW).input(Items.STICK).criterion("has_marshmallow", this.conditionsFrom(CampanionItems.MARSHMALLOW)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionItems.MRE).input(CampanionItemTags.PROTEINS).input(CampanionItemTags.FRUITS).input(CampanionItemTags.GRAINS).input(CampanionItemTags.VEGETABLES).criterion("has_mre_components", this.conditionsFrom(CampanionItemTags.MRE_COMPONENTS)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionItems.CRACKER, 4).input('W', Items.WHEAT).pattern("WW").criterion("has_wheat", this.conditionsFrom(Items.WHEAT)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionItems.SMORE).input(CampanionItems.CRACKER).input(CampanionItemTags.MELTED_MARSHMALLOWS).input(Items.COCOA_BEANS).input(CampanionItems.CRACKER).criterion("has_marshmallow", this.conditionsFrom(CampanionItemTags.MARSHMALLOWS)).offerTo(exporter);

			ShapedRecipeJsonFactory.create(CampanionItems.ROPE).input('S', Items.STRING).pattern("SSS").criterion("has_string", this.conditionsFrom(Items.STRING)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionBlocks.ROPE_BRIDGE_POST, 2).input('L', net.minecraft.tag.ItemTags.LOGS).pattern("L L").pattern("L L").criterion("has_rope", this.conditionsFrom(CampanionItems.ROPE)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionBlocks.ROPE_LADDER, 16).input('R', CampanionItems.ROPE).input('S', Items.STICK).pattern("RSR").pattern("RSR").pattern("RSR").criterion("has_string", this.conditionsFrom(Items.STRING)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionItems.SKIPPING_STONE, 8).input(Blocks.COBBLESTONE).criterion("has_cobblestone", this.conditionsFrom(Blocks.COBBLESTONE)).offerTo(exporter);
			...
			ShapedRecipeJsonFactory.create(CampanionItems.LEATHER_POUCH).input('L', Items.LEATHER).input('S', Items.STRING).pattern("L L").pattern("SLS").criterion("has_leather", this.conditionsFrom(Items.LEATHER)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionItems.TANNED_LEATHER_POUCH).input('T', CampanionItems.TANNED_LEATHER).input('S', Items.STRING).pattern("T T").pattern("T T").pattern("STS").criterion("has_tanned_leather", this.conditionsFrom(CampanionItems.TANNED_LEATHER)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionBlocks.LEATHER_TANNER).input('S', Items.STICK).pattern("S S").pattern("S S").pattern("S S").criterion("has_stick", this.conditionsFrom(Items.STICK)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionItems.DAY_PACK).input('I', Items.IRON_INGOT).input('R', CampanionItems.ROPE).input('P', CampanionItems.LEATHER_POUCH).pattern(" I ").pattern("RPR").criterion("has_leather", this.conditionsFrom(Items.LEATHER)).offerTo(exporter);
			...
			ShapedRecipeJsonFactory.create(CampanionItems.HIKING_PACK).input('I', Items.IRON_INGOT).input('R', CampanionItems.ROPE).input('T', CampanionItems.TANNED_LEATHER_POUCH).pattern(" I ").pattern("RTR").pattern("ITI").criterion("has_tanned_leather", this.conditionsFrom(CampanionItems.TANNED_LEATHER)).offerTo(exporter);
			...
			ShapedRecipeJsonFactory.create(CampanionItems.WOODEN_SPEAR).input('#', CampanionItems.WOODEN_ROD).input('X', net.minecraft.tag.ItemTags.PLANKS).pattern("X").pattern("#").criterion("has_stick", this.conditionsFrom(Items.STICK)).offerTo(exporter);
			ShapedRecipeJsonFactory.create(CampanionItems.STONE_SPEAR).input('#', CampanionItems.WOODEN_ROD).input('X', Blocks.COBBLESTONE).pattern("X").pattern("#").criterion("has_stone", this.conditionsFrom(Blocks.COBBLESTONE)).offerTo(exporter);
			...
			ShapelessRecipeJsonFactory.create(CampanionBlocks.ORANGE_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.ORANGE_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:orange_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.MAGENTA_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.MAGENTA_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_magenta_carpet", this.conditionsFrom(Blocks.MAGENTA_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.MAGENTA_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.MAGENTA_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:magenta_lawn_chair_from_existing_chair");
			...
			ShapelessRecipeJsonFactory.create(CampanionBlocks.LIGHT_BLUE_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.LIGHT_BLUE_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:light_blue_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.YELLOW_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.YELLOW_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_yellow_carpet", this.conditionsFrom(Blocks.YELLOW_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.YELLOW_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.YELLOW_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:yellow_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.LIME_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.LIME_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_lime_carpet", this.conditionsFrom(Blocks.LIME_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.LIME_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.LIME_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:lime_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.PINK_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.PINK_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_pink_carpet", this.conditionsFrom(Blocks.PINK_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.PINK_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.PINK_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:pink_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.GRAY_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.GRAY_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_gray_carpet", this.conditionsFrom(Blocks.GRAY_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.GRAY_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.GRAY_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:gray_lawn_chair_from_existing_chair");
			...
			ShapelessRecipeJsonFactory.create(CampanionBlocks.LIGHT_GRAY_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.LIGHT_GRAY_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:light_gray_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.CYAN_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.CYAN_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_cyan_carpet", this.conditionsFrom(Blocks.CYAN_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.CYAN_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.CYAN_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:cyan_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.PURPLE_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.PURPLE_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_purple_carpet", this.conditionsFrom(Blocks.PURPLE_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.PURPLE_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.PURPLE_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:purple_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.BLUE_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.BLUE_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_blue_carpet", this.conditionsFrom(Blocks.BLUE_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.BLUE_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.BLUE_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:blue_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.BROWN_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.BROWN_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_brown_carpet", this.conditionsFrom(Blocks.BROWN_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.BROWN_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.BROWN_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:brown_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.GREEN_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.GREEN_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_green_carpet", this.conditionsFrom(Blocks.GREEN_CARPET)).offerTo(exporter);
			ShapelessRecipeJsonFactory.create(CampanionBlocks.GREEN_LAWN_CHAIR).input(CampanionItemTags.LAWN_CHAIRS).input(Items.GREEN_DYE).group("dyed_lawn_chair").criterion("has_lawn_chair", this.conditionsFrom(CampanionItemTags.LAWN_CHAIRS)).offerTo(exporter, "campanion:green_lawn_chair_from_existing_chair");
			ShapedRecipeJsonFactory.create(CampanionBlocks.RED_LAWN_CHAIR).input('P', net.minecraft.tag.ItemTags.PLANKS).input('C', Blocks.RED_CARPET).input('S', Items.STICK).pattern("P  ").pattern("PCP").pattern("S S").group("lawn_chair").criterion("has_red_carpet", this.conditionsFrom(Blocks.RED_CARPET)).offerTo(exporter);
