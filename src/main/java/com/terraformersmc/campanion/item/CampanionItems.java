...
public class CampanionItems {
	...
	public static final SpearItem STONE_SPEAR = add("stone_spear", new SpearItem(ToolMaterials.STONE, 4, -3.2F, () -> CampanionEntities.STONE_SPEAR, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final SpearItem IRON_SPEAR = add("iron_spear", new SpearItem(ToolMaterials.IRON, 5, -3.1F, () -> CampanionEntities.IRON_SPEAR, new Item.Settings().group(ItemGroup.COMBAT)));
	...
	public static final SpearItem DIAMOND_SPEAR = add("diamond_spear", new SpearItem(ToolMaterials.DIAMOND, 6, -3.0F, () -> CampanionEntities.DIAMOND_SPEAR, new Item.Settings().group(ItemGroup.COMBAT)));
	public static final SpearItem NETHERITE_SPEAR = add("netherite_spear", new SpearItem(ToolMaterials.NETHERITE, 7, -3.0F, () -> CampanionEntities.NETHERITE_SPEAR, new Item.Settings().group(ItemGroup.COMBAT)));
	...
	public static final UnbuiltTent SMALL_UNBUILT_TENT = add("small_unbuilt_tent", new UnbuiltTent(new Item.Settings().group(ItemGroup.TOOLS).maxCount(1), "small"));
	public static final UnbuiltTent LARGE_UNBUILT_TENT = add("large_unbuilt_tent", new UnbuiltTent(new Item.Settings().group(ItemGroup.TOOLS).maxCount(1), "large"));
